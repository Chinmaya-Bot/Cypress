...
//Below is Login command to login to Any application
Cypress.Commands.add('LoginToAnyApp', (unameloc,upassloc,buttonloc,uname,upass) => {
    // Enter UserName and Password
 
    cy.get(unameloc).type(uname)
    cy.get(upassloc).type(upass)
    cy.get(buttonloc).click()
})
...
//Below is Login command to logout from OrangeHRM application
